...
ITEM = {'id': 'surplus_a_coin',
 ...
 'element': '异象',
 'rarity': 'r',
 'art': '/static/images/item/甲硬币.webp',
 'description': '揭示：手牌中 1 张光或相属性道具下次部署费用 -1；若本回合部署过光属性道具，自身 +1；若本回合部署过盈蓄，额外 +1。',
 ...
 'target_rule': {},
 'icon': '/static/images/item/甲硬币.webp'}
