...
from app.modules.card_game.content.loader import default_duel_deck_id, get_duel_deck, load_duel_decks, validate_duel_deck_card_ids
from app.modules.card_game.content.common.constants import LOCATION_CARD_LIMIT
from app.dao import get_build
from app.modules.card_game.engine.application.build_service import (
    card_by_id,
    card_type,
    normalize_build_payload,
    unique_known_ids,
)
from app.modules.card_game.engine.setup.battlefields import BATTLEFIELD_TRAITS, EFFECT_FIRST_TURN_EXTRA_NORMAL_DRAW
from app.modules.card_game.engine.setup.tutorial_scripts import (
