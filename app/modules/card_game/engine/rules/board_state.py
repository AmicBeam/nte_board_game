...
from app.modules.card_game.engine.rules.declarations import target_rule
from app.modules.card_game.engine.rules.materials import release_material_reservations
...
def has_revealed_tag(location: JsonDict, side: str, tag: str) -> bool:
    from app.modules.card_game.engine.rules.harmony import location_mark_count
